<script src="assets/js/jquery-3.5.1.min.js?v=<?php echo $site_version ?>"></script>
<script src="assets/js/slick.min.js?v=<?php echo $site_version ?>"></script>
<script src="assets/js/fullpage.min.js?v=<?php echo $site_version ?>"></script>
